// Email templates for the newsletter subscription system

export const getEmailConfirmationTemplate = (email: string, token: string) => {
  // In a real application, this would be rendered on the server
  // For this frontend-only implementation, we'll return a simple template
